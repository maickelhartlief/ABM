...
class Model_pp(Model):
    '''
    Description: Modal class to run our model in mesa. Necesarry for batchrunner.
    '''
    def __init__(self,
    ...
    def runmodel(self):
        for network in self.networks:
            ...
            for run in range(self.n_runs):
                ...
                ## create model
                model = Party_model(self.prob_stimulus,
                                    self.prob_interaction,
                                    self.prob_move,
                                    self.prob_link,
                                    self.until_eligible,
                                    self.characteristics_affected,
                                    network,
                                    self.edges_per_step,
                                    self.n_agents,
                                    self.m_barabasi,
